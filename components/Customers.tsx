        ...
        <div className="flex-1 bg-white p-6 rounded-xl shadow-sm">
            ...
            <div className="py-6 space-y-4">
             ...
             <div className="flex gap-2">
                <button className="flex-1 py-2 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50">Editar</button>
                <button className="flex-1 py-2 bg-red-50 border border-red-200 rounded-lg text-red-600 hover:bg-red-100">Eliminar</button>
            </div>
        </div>
    );
};
