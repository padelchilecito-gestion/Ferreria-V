...
export const mockProducts: Product[] = [
  { id: '1', sku: 'TRN-00123', name: 'Tornillo Autorroscante 1/4"', supplier: 'Genérico', stock: 15, minStock: 20, costPrice: 0.10, retailPrice: 0.25, category: 'Tornillería' },
  { id: '2', sku: 'PNT-00456', name: 'Pintura Látex Blanca 1L', supplier: 'Alba', stock: 8, minStock: 10, costPrice: 8.50, retailPrice: 12.00, category: 'Pintura' },
  { id: '3', sku: 'HER-00789', name: 'Martillo de Carpintero', supplier: 'Truper', stock: 5, minStock: 5, costPrice: 12.00, retailPrice: 18.00, category: 'Herramientas' },
  { id: '4', sku: 'HD-98745', name: 'Juego de Destornilladores (6 pz)', supplier: 'Stanley', stock: 25, minStock: 10, costPrice: 25.00, retailPrice: 35.50, category: 'Herramientas' },
  { id: '5', sku: 'HD-33214', name: 'Cinta Métrica 5m', supplier: 'Pretul', stock: 50, minStock: 15, costPrice: 8.00, retailPrice: 12.50, category: 'Herramientas' },
  { id: '6', sku: 'HD-10589', name: 'Taladro Percutor 1/2"', supplier: 'DeWalt', stock: 0, minStock: 5, costPrice: 150.00, retailPrice: 220.00, category: 'Herramientas Eléctricas' },
  { id: '7', sku: 'HD-78901', name: 'Llave Inglesa Ajustable 8"', supplier: 'Craftsman', stock: 18, minStock: 10, costPrice: 18.00, retailPrice: 28.00, category: 'Herramientas' },
  { id: '8', sku: 'ELE-01234', name: 'Cinta Aislante Negra', supplier: '3M', stock: 150, minStock: 50, costPrice: 1.50, retailPrice: 2.50, category: 'Electricidad' },
];
